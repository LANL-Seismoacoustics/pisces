...
from pisces.schema.util import parse_string, parse_int, parse_float
...
algorithm = Column(String(15), 
        info={'default': '-', 'parse': parse_string, 'dtype': 'a15', 'width': 15, 'format': '15.15s'})
amp = Column(Float(24), 
...
amptype = Column(String(8), 
        info={'default': '-', 'parse': parse_string, 'dtype': 'a8', 'width': 8, 'format': '8.8s'})
arid = Column(Integer, 
        info={'default': -1, 'parse': parse_int, 'dtype': 'int', 'width': 9, 'format': '9d'})
auth = Column(String(20), 
        info={'default': '-', 'parse': parse_string, 'dtype': 'a20', 'width': 20, 'format': '20.20s'})
azdef = Column(String(1), 
        info={'default': '-', 'parse': parse_string, 'dtype': 'a1', 'width': 1, 'format': '1.1s'})
...
datatype = Column(String(2),
        info={'default': '-', 'parse': parse_string, 'dtype': 'a2', 'width': 2, 'format': '2.2s'})
...
descrip = Column(String(50), 
        info={'default': '-', 'parse': parse_string, 'dtype': 'a50', 'width': 50, 'format': '50.50s'})
dfile = Column(String(32), 
        info={'default': '-', 'parse': parse_string, 'dtype': 'a32', 'width': 32, 'format': '32.32s'})
digital = Column(String(1), 
        info={'default': '-', 'parse': parse_string, 'dtype': 'a1', 'width': 1, 'format': '1.1s'})
dir = Column(String(64), 
        info={'default': '-', 'parse': parse_string, 'dtype': 'a64', 'width': 64, 'format': '64.64s'})
...
etype = Column(String(7), 
        info={'default': '-', 'parse': parse_string, 'dtype': 'a7', 'width': 7, 'format': '7.7s'})
evid = Column(Integer, 
        info={'default': -1, 'parse': parse_int, 'dtype': 'int', 'width': 9, 'format': '9d'})
...
grname = Column(String(40), 
        info={'default': '-', 'parse': parse_string, 'dtype': 'a40', 'width': 40, 'format': '40.40s'})
...
instype = Column(String(6), 
        info={'default': '-', 'parse': parse_string, 'dtype': 'a6', 'width': 6, 'format': '6.6s'})
...
netname = Column(String(80), 
        info={'default': '-', 'parse': parse_string, 'dtype': 'a80', 'width': 80, 'format': '80.80s'})
nettype = Column(String(4), 
        info={'default': '-', 'parse': parse_string, 'dtype': 'a4', 'width': 4, 'format': '4.4s'})
...
refsta = Column(String(6), 
        info={'default': '-', 'parse': parse_string, 'dtype': 'str', 'width': 6, 'format': '6.6s'})
