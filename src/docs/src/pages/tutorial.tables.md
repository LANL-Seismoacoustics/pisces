...
![lookup tables](data/css3_lookup.png "lookup tables")

Anderson, J., Farrell, W. E., Garcia, K., Given, J., and Swanger, H. (1990). Center for Seismic Studies version 3 database: Schema reference manual. Technical Report C90-01, Center for Seismic Studies, 1300 N. 17th Street, Suite 1450, Arlington, Virginia 22209-3871. [PDF (19 MB)](data/Anderson1990.pdf?raw=true "Anderson et al. (1990) pdf")
...
![ccwfdisc table](data/ancc-ciei_table.png "ccwfdisc table")
